...
const toggleClassName =
    'h-[22px] w-[36px] border-0 bg-[#D8D8DD] data-[state=checked]:bg-[#EC6608] ';
                        ...
                        <div className="overflow-hidden rounded-[24px] border border-[#E7E9F2] bg-[#F3F3F6] shadow-[0_24px_80px_rgba(15,23,42,0.20)]">
                            <div className="flex items-start justify-between gap-4 bg-[#F8F8FA] px-6 py-[22px] min-[1800px]:px-8 min-[1800px]:py-7">
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-[#808080] min-[1800px]:text-base">Настройка поведения презентации</p>
                                </div>
                                ...
                                <div className="flex items-start gap-2">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <Textarea
                                            ...
                                            placeholder="Укажите ИИ: аудиторию, тон, ключевые моменты или ограничения."
                            ...
                            <div className="space-y-4 px-6 pb-5 pt-3.5 min-[1800px]:space-y-5 min-[1800px]:px-8 min-[1800px]:pb-7 min-[1800px]:pt-5">
                                <div className="flex items-center justify-between gap-3">
                                    <label className="font-syne text-sm font-semibold leading-none text-[#1F1D2A] min-[1800px]:text-base">Тон</label>
                                    <Select
                                ...
                                <div className="flex items-center justify-between gap-3">
                                    <label className="font-syne text-sm font-semibold leading-none text-[#1F1D2A] min-[1800px]:text-base">Детализация</label>
                                    <Select
                                    ...
                                    >
                                        <SelectTrigger className="w-[120px] rounded-xl border-[#DBDBE1] bg-white p-2.5 font-syne text-sm font-medium capitalize text-[#2C2B37] shadow-none focus:ring-0 focus-visible:ring-0 min-[1800px]:w-[140px] min-[1800px]:text-base">
                                            <SelectValue placeholder="Выберите детализацию" />
                                        </SelectTrigger>
                                        <SelectContent className="z-[120] font-syne">
                                ...
                                <div className="flex items-center justify-between gap-3">
                                    <label className="font-syne text-sm font-semibold leading-none text-[#1F1D2A] min-[1800px]:text-base">Титульный слайд</label>
                                    <Switch
