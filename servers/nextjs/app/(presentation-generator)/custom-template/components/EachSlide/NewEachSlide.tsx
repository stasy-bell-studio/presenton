      ...
      <div className="px-5 py-4 border-b border-[#F3F4F6] bg-gradient-to-r from-[#FAFAFA] to-white">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#EBE9FE] text-[#EC6608] font-semibold text-sm">
              {index + 1}
            </div>
            <div>
                ...
                >
                  <div className="p-4">
                    ...
                    <textarea
                      ...
                      disabled={isUpdating}
                      className="w-full px-3 py-2.5 rounded-lg border border-gray-200 bg-gray-50 text-sm text-gray-800 placeholder:text-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-400 focus:bg-white transition-all"
                    />
        ...
        {isSlideProcessing && (
          <div className="mt-4">
            <div className="flex items-center gap-2 mb-2">
              <Loader2 className="w-4 h-4 animate-spin text-[#EC6608]" />
              <span className="text-sm font-medium text-[#EC6608]">Generating slide layout...</span>
            </div>
            <Timer duration={120} />
          </div>
        )}
          ...
          {isSelectionEditMode && slide.processed && !slide.processing && (
            <div className="mb-4 flex items-center justify-between bg-orange-50 border border-orange-200 rounded-xl px-4 py-3">
              ...
              <button
                ...
                className="h-8 px-3 text-sm font-medium text-orange-600 hover:text-orange-800 hover:bg-orange-100 rounded-md transition-colors"
              >
                Exit
              </button>
            </div>
