    ...
    const scrollToField = useCallback((path: string) => {
        ...
        setTimeout(() => {
            ...
            if (fieldEl) {
                ...
                fieldEl.classList.add('ring-2', 'ring-orange-500', 'ring-offset-2');
                setTimeout(() => {
                    fieldEl.classList.remove('ring-2', 'ring-orange-500', 'ring-offset-2');
                }, 2000);
            }
        }, 100);
    }, []);
                        ...
                        <div className="flex items-center justify-between mb-1">
                            ...
                            {fields.length > 0 && (
                                <button
                                    ...
                                    className="text-[10px] font-medium text-gray-400 hover:text-orange-600 transition-colors"
                                >
                    ...
                    {parseError ? (
                        ...
                        <div className="space-y-1 px-2 ">
                            {hierarchicalFields.map(({ field, children }) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`rounded-md border transition-all my-3 ${isHighlighted
                                                ? 'border-orange-400 bg-orange-50/60 ring-2 ring-orange-300'
                                                : fModified
                                        ...
                                        >
                                            ...
                                            >
                                                <div className="flex items-center gap-2 min-w-0">
                                                    ...
                                                    {f.type === 'array' && <List className="w-3.5 h-3.5 text-orange-400 flex-shrink-0" />}
                                                    ...
                                                    {/* Highlight indicator */}
                                                    {isHighlighted && (
                                                        <span className="flex items-center gap-1 text-[9px] px-1.5 py-0.5 bg-orange-100 text-orange-600 rounded">
                                ...
                                const borderColor = isArrayParent ? 'border-orange-200' : 'border-blue-200';
                                const lineColor = isArrayParent ? 'bg-orange-200' : 'bg-blue-200';
                                const textColor = isArrayParent ? 'text-orange-500' : 'text-blue-500';
                                const bgColor = isArrayParent ? 'bg-orange-50' : 'bg-blue-50';
                                const badgeTextColor = isArrayParent ? 'text-orange-400' : 'text-blue-400';
